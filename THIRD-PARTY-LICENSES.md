...
Workbench bundles the following. Their licences require that the copyright and
permission notices be retained in distributions.

## thinking-orbs — MIT
Copyright (c) 2026 Jakub Antalik — https://github.com/Jakubantalik/thinking-orbs

## lucide-react (Lucide) — ISC
...
- Fraunces — Undercase Type. Full text: src/assets/fonts/LICENSE-Fraunces-OFL.txt
- Inter — Rasmus Andersson. Full text: src/assets/fonts/LICENSE-Inter-OFL.txt
- Commit Mono — Eigil Nikolajsen. Full text: src/assets/fonts/LICENSE-CommitMono-OFL.txt
